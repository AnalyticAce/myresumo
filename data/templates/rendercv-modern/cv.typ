// PowerCV integration for RenderCV Modern template
#import "@preview/rendercv:0.1.0": *

// Apply the rendercv template with modern configuration
#show: rendercv.with(
...
#connections(
  ...
  if data.user_information.email != none and data.user_information.email != "" {
    [#link("mailto:" + data.user_information.email, icon: false, if-underline: true, if-color: true)[#connection-with-icon("envelope")[data.user_information.email]]]
  },
  ...
  if data.user_information.linkedin != none and data.user_information.linkedin != "" {
    [#link("https://" + data.user_information.linkedin, icon: false, if-underline: true, if-color: true)[#connection-with-icon("linkedin")[data.user_information.linkedin]]]
  },
  if data.user_information.github != none and data.user_information.github != "" {
    [#link("https://" + data.user_information.github, icon: false, if-underline: true, if-color: true)[#connection-with-icon("github")[data.user_information.github]]]
  },
  if data.user_information.homepage != none and data.user_information.homepage != "" {
    [#link(data.user_information.homepage, icon: false, if-underline: true, if-color: true)[#connection-with-icon("globe")[data.user_information.homepage]]]
  },
)
